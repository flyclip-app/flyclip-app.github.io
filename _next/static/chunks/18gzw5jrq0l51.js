...
actions:
  - title: Amazon
    ...
    spaces as plus: true
    requirements: [text]`}];var s=e.i(62368),l=e.i(56420);let a=(0,l.default)("eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),c=(0,l.default)("settings",[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),r=(0,l.default)("zap",[["path",{d:"M15.914 4a1.5 1.5 0 00-2.474-1.561l-9 9A1.5 1.5 0 005.5 14h4.002a.5.5 0 01.471.666L8.086 20a1.5 1.5 0 002.475 1.56l9-9A1.5 1.5 0 0018.5 10h-3.997a.5.5 0 01-.472-.667z",key:"1v7up4"}]]);function p({extension:e,onOpenModal:i}){let n=o(e.id),l=`https://flyclip-app.github.io/downloads/extensions/${n}.flyclipextz`,d=`flyclip://install-extension?url=${encodeURIComponent(l)}&id=${encodeURIComponent(e.id)}&name=${encodeURIComponent(e.name)}`,m=`/downloads/extensions/${n}.flyclipextz`;return(0,t.jsxs)("div",{className:"bg-[#1c1e27] border border-[#2d3142] hover:border-blue-500/60 rounded-xl p-5 flex flex-col justify-between transition-all hover:-translate-y-1 hover:shadow-xl group",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-start gap-3.5 mb-3",children:[(0,t.jsx)("div",{className:"w-11 h-11 rounded-lg bg-[#14161d] border border-[#2d3142] flex items-center justify-center font-bold text-base text-blue-400 group-hover:border-blue-500/40 transition-colors flex-shrink-0",children:e.icon}),(0,t.jsxs)("div",{className:"min-w-0 flex-1",children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-base leading-snug truncate",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono truncate",children:e.id})]})]}),(0,t.jsx)("p",{className:"text-sm text-slate-400 leading-relaxed mb-4 line-clamp-2",children:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4 flex-wrap",children:[(0,t.jsx)("span",{className:"text-xs px-2 py-0.5 rounded bg-[#14161d] text-slate-400 border border-[#2d3142]",children:(e=>{switch(e){case"translation":return"翻译词典";case"search_ai":return"搜索与AI";case"text_tools":return"文本处理";case"developer":return"开发工具";case"shopping":return"电商媒体";default:return"通用"}})(e.category)}),(0,t.jsx)("span",{className:"text-xs px-2 py-0.5 rounded bg-[#14161d] text-slate-400 border border-[#2d3142]",children:e.type.toUpperCase()}),e.hasOptions&&(0,t.jsxs)("span",{className:"text-xs px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-1",children:[(0,t.jsx)(c,{size:11})," 选项配置"]})]}),(0,t.jsxs)("div",{className:"pt-3 border-t border-[#2d3142] flex items-center gap-2",children:[(0,t.jsxs)("a",{href:d,target:"_blank",rel:"noopener noreferrer",title:"通过 flyclip:// 协议直接在新标签页打开并呼起客户端安装",className:"flex-1 py-1.5 px-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center justify-center gap-1.5 transition-all shadow-md shadow-blue-500/20 active:scale-95",children:[(0,t.jsx)(r,{size:13,className:"text-amber-300"}),(0,t.jsx)("span",{children:"一键安装"})]}),(0,t.jsx)("a",{href:m,download:`${n}.flyclipextz`,title:"下载离线 .flyclipextz 文件",className:"p-1.5 rounded-lg bg-[#14161d] border border-[#2d3142] hover:border-slate-400 text-slate-300 hover:text-white transition-colors",children:(0,t.jsx)(s.Download,{size:14})}),(0,t.jsxs)("button",{onClick:()=>i(e),title:"查看扩展详情与源码",className:"py-1.5 px-2.5 rounded-lg bg-[#14161d] border border-[#2d3142] hover:border-slate-400 text-slate-300 hover:text-white text-xs font-semibold flex items-center justify-center gap-1 transition-colors",children:[(0,t.jsx)(a,{size:13}),(0,t.jsx)("span",{children:"详情"})]})]})]})]})}var d=e.i(63676),m=e.i(8734),x=e.i(89664);let h=(0,l.default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]),f=(0,l.default)("external-link",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);var u=e.i(22016);function y({extension:e,onClose:n}){let[l,a]=(0,i.useState)(!1);if(!e)return null;let c=o(e.id),p=`https://flyclip-app.github.io/downloads/extensions/${c}.flyclipextz`,g=`flyclip://install-extension?url=${encodeURIComponent(p)}&id=${encodeURIComponent(e.id)}&name=${encodeURIComponent(e.name)}`,b=`# flyclip
${e.configYaml}`,w=`flyclip://install-extension?name=${encodeURIComponent(e.name)}&data=${encodeURIComponent(b)}`,v=`/downloads/extensions/${c}.flyclipextz`;return(0,t.jsx)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200",children:(0,t.jsxs)("div",{className:"w-full max-w-2xl bg-[#1c1e27] border border-[#2d3142] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]",children:[(0,t.jsxs)("div",{className:"p-5 border-b border-[#2d3142] flex items-center justify-between bg-[#14161d]",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 rounded-lg bg-[#1c1e27] border border-[#2d3142] flex items-center justify-center font-bold text-blue-400",children:e.icon}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-lg",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono",children:e.id})]})]}),(0,t.jsx)("button",{onClick:n,className:"w-8 h-8 rounded-lg flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-colors",children:(0,t.jsx)(d.X,{size:18})})]}),(0,t.jsxs)("div",{className:"p-6 overflow-y-auto space-y-6 text-sm text-slate-300",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider block mb-1",children:"功能描述"}),(0,t.jsx)("p",{className:"text-slate-300",children:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{className:"space-y-3",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider block",children:"安装与更新方式"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:[(0,t.jsxs)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-blue-500/40 space-y-2 flex flex-col justify-between",children:[(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 font-bold text-white text-xs",children:[(0,t.jsx)(r,{size:14,className:"text-amber-400"}),(0,t.jsx)("span",{children:"方式一：一键唤起安装 (绑定更新源)"})]}),(0,t.jsxs)("p",{className:"text-[11px] text-slate-400 leading-relaxed",children:["通过 ",(0,t.jsx)("code",{children:"flyclip://"})," 协议在新标签页呼出本地 FlyClip，自动绑定官方更新源。"]})]}),(0,t.jsxs)("a",{href:g,target:"_blank",rel:"noopener noreferrer",className:"w-full py-2 px-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs flex items-center justify-center gap-1.5 transition-colors shadow-md shadow-blue-500/20",children:[(0,t.jsx)(r,{size:13,className:"text-amber-300"}),(0,t.jsx)("span",{children:"一键安装到 FlyClip"}),(0,t.jsx)(f,{size:12})]})]}),(0,t.jsxs)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-[#2d3142] space-y-2 flex flex-col justify-between",children:[(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 font-bold text-white text-xs",children:[(0,t.jsx)(s.Download,{size:14,className:"text-blue-400"}),(0,t.jsx)("span",{children:"方式二：下载离线包 (.flyclipextz)"})]}),(0,t.jsxs)("p",{className:"text-[11px] text-slate-400 leading-relaxed",children:["下载 ",(0,t.jsxs)("code",{children:[c,".flyclipextz"]})," 文件，双击或拖入 FlyClip 窗口即可完成安装。"]})]}),(0,t.jsxs)("a",{href:v,download:`${c}.flyclipextz`,className:"w-full py-2 px-3 rounded-lg bg-[#1c1e27] border border-[#2d3142] hover:border-slate-400 text-slate-200 font-semibold text-xs flex items-center justify-center gap-1.5 transition-colors",children:[(0,t.jsx)(s.Download,{size:13}),(0,t.jsx)("span",{children:"下载离线文件"})]})]})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider",children:"方式三：划选即装 Snippet (直接用鼠标划选下方文本即可)"}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsxs)("a",{href:w,target:"_blank",rel:"noopener noreferrer",className:"text-xs text-amber-400 hover:text-amber-300 flex items-center gap-1 font-medium",children:[(0,t.jsx)(r,{size:12}),(0,t.jsx)("span",{children:"载入 Snippet"}),(0,t.jsx)(f,{size:11})]}),(0,t.jsxs)("button",{onClick:()=>{navigator.clipboard.writeText(b),a(!0),setTimeout(()=>a(!1),2e3)},className:"text-xs text-blue-400 hover:text-blue-300 flex items-center gap-1 font-medium",children:[l?(0,t.jsx)(x.Check,{size:12,className:"text-green-400"}):(0,t.jsx)(m.Copy,{size:12}),(0,t.jsx)("span",{children:l?"已复制":"复制代码"})]})]})]}),(0,t.jsx)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-[#2d3142] overflow-x-auto font-mono text-xs text-slate-200 leading-relaxed select-all",children:(0,t.jsx)("pre",{children:b})})]})]}),(0,t.jsxs)("div",{className:"p-4 border-t border-[#2d3142] bg-[#14161d] flex items-center justify-between gap-3",children:[(0,t.jsxs)(u.default,{href:"/download",className:"text-xs text-blue-400 hover:text-blue-300 flex items-center gap-1 font-medium",children:[(0,t.jsx)("span",{children:"还没有 FlyClip 客户端？立即下载"}),(0,t.jsx)(h,{size:13})]}),(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsxs)("a",{href:g,target:"_blank",rel:"noopener noreferrer",className:"px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs sm:text-sm transition-colors flex items-center gap-1.5 shadow-md shadow-blue-500/20",children:[(0,t.jsx)(r,{size:14,className:"text-amber-300"}),(0,t.jsx)("span",{children:"一键安装到 FlyClip"}),(0,t.jsx)(f,{size:12})]}),(0,t.jsx)("button",{onClick:n,className:"px-4 py-2 rounded-lg bg-[#1c1e27] border border-[#2d3142] hover:bg-[#242733] text-slate-300 font-medium text-xs sm:text-sm transition-colors",children:"关闭"})]})]})]})})}var g=e.i(66595),b=e.i(28623);e.s(["default",0,function(){let[e,o]=(0,i.useState)(""),[s,l]=(0,i.useState)("all"),[a,c]=(0,i.useState)(null),r=n.filter(t=>{let i="all"===s||t.category===s,o=e.toLowerCase().trim(),n=!o||t.name.toLowerCase().includes(o)||t.id.toLowerCase().includes(o)||t.description&&t.description.toLowerCase().includes(o)||t.descriptionZh&&t.descriptionZh.toLowerCase().includes(o);return i&&n});return(0,t.jsxs)("div",{className:"py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto",children:[(0,t.jsxs)("div",{className:"text-center max-w-2xl mx-auto mb-10 space-y-2",children:[(0,t.jsx)("span",{className:"text-xs font-bold text-blue-400 uppercase tracking-wider",children:"Extension Marketplace"}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-extrabold text-white",children:"官方与社区扩展中心"}),(0,t.jsx)("p",{className:"text-slate-400 text-sm sm:text-base",children:"已为 Windows 深度优化 40+ 个原生扩展，点击「一键安装」或下载扩展包即可秒级使用。"})]}),(0,t.jsxs)("div",{className:"space-y-4 mb-10",children:[(0,t.jsxs)("div",{className:"relative w-full max-w-2xl mx-auto",children:[(0,t.jsx)(g.Search,{className:"absolute left-4 top-1/2 -translate-y-1/2 text-slate-500",size:18}),(0,t.jsx)("input",{type:"text",placeholder:"搜索扩展名称、标识符、功能描述或关键词...",value:e,onChange:e=>o(e.target.value),className:"w-full pl-11 pr-4 py-3 rounded-xl bg-[#1c1e27] border border-[#2d3142] text-sm text-slate-100 focus:outline-none focus:border-blue-500 transition-colors placeholder:text-slate-500 shadow-lg"})]}),(0,t.jsxs)("div",{className:"flex items-center justify-between flex-wrap gap-3 pt-2",children:[(0,t.jsx)("div",{className:"flex items-center gap-2 flex-wrap",children:[{id:"all",label:"全部"},{id:"translation",label:"翻译词典"},{id:"search_ai",label:"搜索与 AI"},{id:"text_tools",label:"文本处理"},{id:"developer",label:"开发工具"},{id:"shopping",label:"电商媒体"}].map(e=>(0,t.jsx)("button",{onClick:()=>l(e.id),className:`px-3.5 py-1.5 rounded-full text-xs font-medium transition-colors ${s===e.id?"bg-blue-600 text-white font-semibold shadow-md shadow-blue-500/20":"bg-[#1c1e27] border border-[#2d3142] text-slate-400 hover:text-white hover:border-slate-400"}`,children:e.label},e.id))}),(0,t.jsxs)("span",{className:"text-xs text-slate-500 font-medium",children:["找到 ",r.length," 个扩展"]})]})]}),r.length>0?(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:r.map(e=>(0,t.jsx)(p,{extension:e,onOpenModal:c},e.id))}):(0,t.jsxs)("div",{className:"text-center py-20 bg-[#14161d] border border-[#2d3142] rounded-2xl p-8",children:[(0,t.jsx)(b.Sparkles,{className:"w-10 h-10 text-slate-500 mx-auto mb-3"}),(0,t.jsx)("h3",{className:"text-lg font-bold text-white mb-1",children:"没有找到匹配的扩展"}),(0,t.jsx)("p",{className:"text-sm text-slate-400",children:"尝试更换搜索词或选择其他分类"})]}),(0,t.jsx)(y,{extension:a,onClose:()=>c(null)})]})}],93063)}]);
...
actions:
  - title: DeepL
    ...
    requirements: [text]`},{id:"com.flyclip.extension.baidu-translate",name:"百度翻译",nameZh:"百度翻译",nameEn:"Baidu Translate",category:"translation",icon:"百翻",description:"Translate text with Baidu Translate.",descriptionZh:"使用百度翻译引擎翻译选中文本。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: Baidu Translate
...
actions:
  - title: 百度翻译
    ...
    requirements: [text]`},{id:"com.flyclip.extension.youdao-dict",name:"有道词典",nameZh:"有道词典",nameEn:"Youdao Dictionary",category:"translation",icon:"有道",description:"Look up words in Youdao Dictionary.",descriptionZh:"有道词典划词查词与权威翻译释义。",hasOptions:!1,type:"url",configYaml:`name: Youdao Dictionary
identifier: com.flyclip.extension.youdao-dict
icon: 有道
actions:
  - title: 有道词典
    url: https://dict.youdao.com/search?q={flyclip text}
    requirements: [text]`},{id:"com.flyclip.extension.wikipedia",name:"Wikipedia",nameZh:"维基百科",nameEn:"Wikipedia",category:"translation",icon:"W",description:"Search Wikipedia encyclopedia in multiple languages.",descriptionZh:"在维基百科中搜索选中文本词条。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: Wikipedia
...
actions:
  - title: MDN
    ...
    requirements: [text]`},{id:"com.flyclip.extension.urban-dictionary",name:"Urban Dictionary",nameZh:"Urban 俚语词典",nameEn:"Urban Dictionary",category:"translation",icon:"UD",description:"Look up slang and idioms on Urban Dictionary.",descriptionZh:"在 Urban Dictionary 查询英语流行俚语与俗语含义。",hasOptions:!1,type:"url",configYaml:`name: Urban Dictionary
identifier: com.flyclip.extension.urban-dictionary
icon: UD
actions:
  - title: Urban Dict
    url: https://www.urbandictionary.com/define.php?term={flyclip text}
    requirements: [text]`},{id:"com.flyclip.extension.google-search",name:"Google Search",nameZh:"Google 搜索",nameEn:"Google Search",category:"search_ai",icon:"G",description:"Search the web with Google Search.",descriptionZh:"使用 Google 搜索选中的关键词。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: Google Search
...
actions:
  - title: Google
    ...
    requirements: [text]`},{id:"com.flyclip.extension.baidu-search",name:"百度搜索",nameZh:"百度搜索",nameEn:"Baidu Search",category:"search_ai",icon:"百度",description:"Search with Baidu Search Engine.",descriptionZh:"使用百度搜索选中的关键词。",hasOptions:!1,type:"url",configYaml:`name: 百度搜索
identifier: com.flyclip.extension.baidu-search
icon: iconify:simple-icons:baidu
actions:
  - title: 百度
    url: https://www.baidu.com/s?wd=***
    requirements: [text]`},{id:"com.flyclip.extension.bing-search",name:"Bing Search",nameZh:"必应搜索",nameEn:"Bing Search",category:"search_ai",icon:"Bing",description:"Search with Microsoft Bing.",descriptionZh:"使用微软必应 Bing 搜索选中文本。",hasOptions:!1,type:"url",configYaml:`name: Bing Search
identifier: com.flyclip.extension.bing-search
icon: iconify:simple-icons:microsoftbing
actions:
  - title: Bing
    url: https://www.bing.com/search?q=***
    requirements: [text]`},{id:"com.flyclip.extension.duckduckgo",name:"DuckDuckGo",nameZh:"DuckDuckGo",nameEn:"DuckDuckGo",category:"search_ai",icon:"DDG",description:"Privacy search with DuckDuckGo.",descriptionZh:"使用 DuckDuckGo 隐私无追踪搜索引擎。",hasOptions:!1,type:"url",configYaml:`name: DuckDuckGo
identifier: com.flyclip.extension.duckduckgo
icon: iconify:simple-icons:duckduckgo
actions:
  - title: DDG
    url: https://duckduckgo.com/?q=***
    requirements: [text]`},{id:"com.flyclip.extension.github-search",name:"GitHub Search",nameZh:"GitHub 搜索",nameEn:"GitHub Search",category:"search_ai",icon:"GH",description:"Search repositories, code, and issues on GitHub.",descriptionZh:"在 GitHub 搜索开源仓库、源码片段或 Issue 问题。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: GitHub Search
...
actions:
  - title: GitHub
    ...
    requirements: [text]`},{id:"com.flyclip.extension.chatgpt",name:"ChatGPT",nameZh:"ChatGPT",nameEn:"ChatGPT",category:"search_ai",icon:"GPT",description:"Ask ChatGPT or analyze text with OpenAI.",descriptionZh:"快速将选中文本发送给 ChatGPT 进行提问或智能分析。",hasOptions:!1,type:"url",configYaml:`name: ChatGPT
identifier: com.flyclip.extension.chatgpt
icon: iconify:simple-icons:openai
actions:
  - title: ChatGPT
    url: https://chatgpt.com/?q=***
    requirements: [text]`},{id:"com.flyclip.extension.claude",name:"Claude",nameZh:"Claude",nameEn:"Claude",category:"search_ai",icon:"Claude",description:"Send selected text to Anthropic Claude AI.",descriptionZh:"发送选中文本给 Anthropic Claude 对话交互。",hasOptions:!1,type:"url",configYaml:`name: Claude
identifier: com.flyclip.extension.claude
icon: iconify:simple-icons:anthropic
actions:
  - title: Claude
    url: https://claude.ai/new?q=***
    requirements: [text]`},{id:"com.flyclip.extension.deepseek",name:"DeepSeek",nameZh:"DeepSeek 深度求索",nameEn:"DeepSeek",category:"search_ai",icon:"DS",description:"Ask DeepSeek AI with selected text.",descriptionZh:"发送选中文本给 DeepSeek 深度求索 AI 助手分析。",hasOptions:!1,type:"url",configYaml:`name: DeepSeek
identifier: com.flyclip.extension.deepseek
icon: DS
actions:
  - title: DeepSeek
    url: https://chat.deepseek.com/?q=***
    requirements: [text]`},{id:"com.flyclip.extension.zhihu-search",name:"知乎搜索",nameZh:"知乎搜索",nameEn:"Zhihu Search",category:"search_ai",icon:"知",description:"Search questions and discussions on Zhihu.",descriptionZh:"在知乎搜索相关问题、高赞回答与专栏文章。",hasOptions:!1,type:"url",configYaml:`name: 知乎搜索
identifier: com.flyclip.extension.zhihu-search
icon: iconify:simple-icons:zhihu
actions:
  - title: 知乎
    url: https://www.zhihu.com/search?type=content&q=***
    requirements: [text]`},{id:"com.flyclip.extension.bilibili-search",name:"哔哩哔哩",nameZh:"哔哩哔哩",nameEn:"Bilibili Search",category:"search_ai",icon:"B站",description:"Search anime, tutorials, and creators on Bilibili.",descriptionZh:"在哔哩哔哩搜索精选视频、教程与UP主。",hasOptions:!1,type:"url",configYaml:`name: 哔哩哔哩
identifier: com.flyclip.extension.bilibili-search
icon: iconify:simple-icons:bilibili
actions:
  - title: 哔哩哔哩
    url: https://search.bilibili.com/all?keyword=***
    requirements: [text]`},{id:"com.flyclip.extension.youtube-search",name:"YouTube",nameZh:"YouTube",nameEn:"YouTube Search",category:"search_ai",icon:"YT",description:"Search videos on YouTube.",descriptionZh:"在 YouTube 上搜索全球精彩视频。",hasOptions:!1,type:"url",configYaml:`name: YouTube
identifier: com.flyclip.extension.youtube-search
icon: iconify:simple-icons:youtube
actions:
  - title: YouTube
    url: https://www.youtube.com/results?search_query=***
    requirements: [text]`},{id:"com.flyclip.extension.case-converter",name:"Case Converter",nameZh:"大小写转换",nameEn:"Case Converter",category:"text_tools",icon:"Aa",description:"Convert text between UPPER, lower, Title, camelCase, snake_case, kebab-case.",descriptionZh:"全能大小写命名风格转换（大写/小写/词首/小驼峰/下划线/连字符）。",hasOptions:!1,type:"js",configYaml:`name: Case Converter
  ...
  - title: 连字符 (kebab-case)
    javascript: |
      return flyclip.input.text
        ...
        .replace(/^-+|-+$/g, '')
        .toLowerCase();
    after: paste-result`},{id:"com.flyclip.extension.base64",name:"Base64",nameZh:"Base64 编解码",nameEn:"Base64",category:"text_tools",icon:"B64",description:"Encode or decode Base64 strings with optional URL-safe mode.",descriptionZh:"Base64 快速编码与解码，支持 URL 安全模式开关。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Base64
...
actions:
  ...
  - title: Base64 解码
    ...
    after: paste-result`},{id:"com.flyclip.extension.url-encode",name:"URL Encode",nameZh:"URL 编解码",nameEn:"URL Encode",category:"text_tools",icon:"%20",description:"Percent-encode and decode URL parameters.",descriptionZh:"URL 百分号编码与反向解码。",hasOptions:!1,type:"js",configYaml:`name: URL Encode
...
actions:
  ...
  - title: URL 解码
    ...
    after: paste-result`},{id:"com.flyclip.extension.html-encode",name:"HTML Encode",nameZh:"HTML 实体转义",nameEn:"HTML Encode",category:"text_tools",icon:"<&>",description:"Encode or decode HTML special character entities.",descriptionZh:"HTML 特殊实体符号转义与反转义。",hasOptions:!1,type:"js",configYaml:`name: HTML Encode
  ...
  - title: HTML 反转义
    javascript: |
      return flyclip.input.text
        ...
        .replace(/&#039;/g, "'")
        .replace(/&#39;/g, "'");
    after: paste-result`},{id:"com.flyclip.extension.json-formatter",name:"JSON Formatter",nameZh:"JSON 格式化",nameEn:"JSON Formatter",category:"text_tools",icon:"{}",description:"Prettify or minify JSON text in place.",descriptionZh:"JSON 格式化美化排版或单行压缩。",hasOptions:!1,type:"js",configYaml:`name: JSON Formatter
...
actions:
  ...
  - title: 压缩 JSON
    ...
    after: paste-result`},{id:"com.flyclip.extension.text-statistics",name:"Text Statistics",nameZh:"字数与文本统计",nameEn:"Text Statistics",category:"text_tools",icon:"123",description:"Count characters, words, lines, and bytes in selected text.",descriptionZh:"实时统计字符数、词数、行数与字节大小并展示于提示栏。",hasOptions:!1,type:"js",configYaml:`name: Text Statistics
...
actions:
  - title: 字数统计
    ...
    after: show-result`},{id:"com.flyclip.extension.sort-lines",name:"Sort Lines",nameZh:"文本行排序与去重",nameEn:"Sort Lines",category:"text_tools",icon:"AZ",description:"Sort lines ascending, descending, or remove duplicate lines.",descriptionZh:"多行文本升序、降序排序与行去重。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Sort Lines
...
actions:
  ...
  - title: 行去重 (Unique)
    ...
    after: paste-result`},{id:"com.flyclip.extension.join-lines",name:"Join Lines",nameZh:"多行合并为单行",nameEn:"Join Lines",category:"text_tools",icon:"->",description:"Join multi-line text into a single line with custom delimiters.",descriptionZh:"多行合并为单行，支持指定逗号、空格、分号等分隔符。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Join Lines
...
actions:
  - title: 合并单行
    ...
    after: paste-result`},{id:"com.flyclip.extension.remove-spaces",name:"Remove Spaces",nameZh:"清除多余空格",nameEn:"Remove Spaces",category:"text_tools",icon:"␣",description:"Collapse duplicate spaces or strip all whitespace characters.",descriptionZh:"消除所有多余空格或压缩连续空白字符。",hasOptions:!1,type:"js",configYaml:`name: Remove Spaces
...
actions:
  ...
  - title: 消除所有空格
    ...
    after: paste-result`},{id:"com.flyclip.extension.full-half-width",name:"全角半角转换",nameZh:"全角半角转换",nameEn:"Full/Half Width",category:"text_tools",icon:"全半",description:"Convert between Full-width and Half-width characters.",descriptionZh:"全角标点字符与半角英文字符双向转换。",hasOptions:!1,type:"js",configYaml:`name: 全角半角转换
...
actions:
  ...
  - title: 半角转全角
    javascript: |
      ...
      return str;
    after: paste-result`},{id:"com.flyclip.extension.timestamp-converter",name:"Timestamp Converter",nameZh:"时间戳转换",nameEn:"Timestamp Converter",category:"text_tools",icon:"⏱️",description:"Convert Unix epoch timestamps to local date-time strings.",descriptionZh:"Unix 时间戳转换为本地日期时间，或获取当前秒级时间戳。",hasOptions:!1,type:"js",configYaml:`name: Timestamp Converter
  ...
  - title: 引用
    javascript: |
      return flyclip.input.text
        ...
        .map(line => \`> \${line}\`)
        .join("\\n");
    after: paste-result`},{id:"com.flyclip.extension.calculate",name:"Calculate",nameZh:"即时数学计算",nameEn:"Calculate",category:"developer",icon:"=?",description:"Evaluate math expressions instantly (e.g. 128*1024, (50+20)/3).",descriptionZh:"即时计算选中的数学表达式并显示结果。",hasOptions:!1,type:"js",configYaml:`name: Calculate
...
actions:
  - title: 计算结果
    ...
    after: show-result`},{id:"com.flyclip.extension.regex101",name:"Regex101",nameZh:"Regex101 正则测试",nameEn:"Regex101",category:"developer",icon:".*",description:"Test and debug regular expressions in Regex101.",descriptionZh:"在 Regex101 中测试并分析正则表达式。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: Regex101
...
actions:
  - title: Regex101
    ...
    requirements: [text]`},{id:"com.flyclip.extension.ip-lookup",name:"IP Lookup",nameZh:"IP 归属地查询",nameEn:"IP Lookup",category:"developer",icon:"IP",description:"Query IP address geolocation and WHOIS info.",descriptionZh:"查询 IP 地址的地理位置、归属地与网络 ASN 信息。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: IP Lookup
identifier: com.flyclip.extension.ip-lookup
icon: IP
actions:
  - title: IP 查询
    url: https://ipinfo.io/{flyclip text}
    requirements: [text]`},{id:"com.flyclip.extension.hash-generator",name:"Hash Generator",nameZh:"哈希值计算",nameEn:"Hash Generator",category:"developer",icon:"#",description:"Calculate MD5 and SHA-256 hashes of selected text.",descriptionZh:"快速计算文本的 MD5 与 SHA-256 哈希值。",hasOptions:!0,optionsCount:1,type:"powershell",configYaml:`name: Hash Generator
...
actions:
  ...
  - title: SHA256
    shell script: |
      ...
      if ($env:FLYCLIP_OPTION_UPPERCASE -ne "1") { $hex = $hex.ToLower() }
      Write-Host -NoNewline $hex
    after: paste-result`},{id:"com.flyclip.extension.iconify-search",name:"Iconify Icons",nameZh:"Iconify 矢量图标",nameEn:"Iconify Icons",category:"developer",icon:"Icon",description:"Search 200,000+ open source vector icons on Iconify.",descriptionZh:"在 Iconify 搜索超过 20 万个开源矢量图标与 SVG 代码。",hasOptions:!1,type:"url",configYaml:`name: Iconify Search
identifier: com.flyclip.extension.iconify-search
icon: iconify:simple-icons:iconify
actions:
  - title: Iconify
    url: https://icon-sets.iconify.design/?query=***
    requirements: [text]`},{id:"com.flyclip.extension.jd-search",name:"京东搜索",nameZh:"京东搜索",nameEn:"JD Search",category:"shopping",icon:"JD",description:"Search products on JD.com.",descriptionZh:"在京东商城搜索选中的商品与数码好物。",hasOptions:!1,type:"url",configYaml:`name: 京东搜索
identifier: com.flyclip.extension.jd-search
icon: iconify:simple-icons:jd
actions:
  - title: 京东
    url: https://search.jd.com/Search?keyword=***
    requirements: [text]`},{id:"com.flyclip.extension.taobao-search",name:"淘宝搜索",nameZh:"淘宝搜索",nameEn:"Taobao Search",category:"shopping",icon:"淘",description:"Search items and deals on Taobao.",descriptionZh:"在淘宝网搜索选中的商品宝贝与优惠。",hasOptions:!1,type:"url",configYaml:`name: 淘宝搜索
identifier: com.flyclip.extension.taobao-search
icon: iconify:simple-icons:taobao
actions:
  - title: 淘宝
    url: https://s.taobao.com/search?q=***
    requirements: [text]`},{id:"com.flyclip.extension.douban-search",name:"豆瓣搜索",nameZh:"豆瓣搜索",nameEn:"Douban Search",category:"shopping",icon:"豆",description:"Search movies, books, and music on Douban.",descriptionZh:"在豆瓣搜索高分电影、热门图书与音乐条目。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: 豆瓣搜索
...
actions:
  - title: 豆瓣
    ...
    requirements: [text]`},{id:"com.flyclip.extension.imdb",name:"IMDb",nameZh:"IMDb 影视资料",nameEn:"IMDb",category:"shopping",icon:"IMDb",description:"Search movies, TV shows, and cast on IMDb.",descriptionZh:"在 IMDb 数据库搜索电影、剧集与演员资料。",hasOptions:!1,type:"url",configYaml:`name: IMDb
identifier: com.flyclip.extension.imdb
icon: iconify:simple-icons:imdb
actions:
  - title: IMDb
    url: https://www.imdb.com/find?q=***
    requirements: [text]`},{id:"com.flyclip.extension.amazon",name:"Amazon",nameZh:"亚马逊商城",nameEn:"Amazon",category:"shopping",icon:"Amz",description:"Search Amazon worldwide with site selection.",descriptionZh:"在全球 Amazon 亚马逊商城（美/中/日/英/德）搜索商品。",hasOptions:!0,optionsCount:1,type:"url",configYaml:`name: Amazon

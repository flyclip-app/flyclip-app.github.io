...
actions:
  - title: YouTube
    ...
    requirements: [text]`},{id:"com.flyclip.extension.case-converter",name:"Case Converter",category:"text_tools",icon:"Aa",description:"Convert text between UPPER, lower, Title, camelCase, snake_case, kebab-case.",descriptionZh:"全能大小写命名风格转换（大写/小写/词首/小驼峰/下划线/连字符）。",hasOptions:!1,type:"js",configYaml:`name: Case Converter
  ...
  - title: 连字符 (kebab-case)
    javascript: |
      return flyclip.input.text
        ...
        .replace(/^-+|-+$/g, '')
        .toLowerCase();
    after: paste-result`},{id:"com.flyclip.extension.base64",name:"Base64",category:"text_tools",icon:"B64",description:"Encode or decode Base64 strings with optional URL-safe mode.",descriptionZh:"Base64 快速编码与解码，支持 URL 安全模式开关。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Base64
...
actions:
  ...
  - title: Base64 解码
    ...
    after: paste-result`},{id:"com.flyclip.extension.url-encode",name:"URL Encode",category:"text_tools",icon:"%20",description:"Percent-encode and decode URL parameters.",descriptionZh:"URL 百分号编码与反向解码。",hasOptions:!1,type:"js",configYaml:`name: URL Encode
...
actions:
  ...
  - title: URL 解码
    ...
    after: paste-result`},{id:"com.flyclip.extension.html-encode",name:"HTML Encode",category:"text_tools",icon:"<&>",description:"Encode or decode HTML special character entities.",descriptionZh:"HTML 特殊实体符号转义与反转义。",hasOptions:!1,type:"js",configYaml:`name: HTML Encode
  ...
  - title: HTML 反转义
    javascript: |
      return flyclip.input.text
        ...
        .replace(/&#039;/g, "'")
        .replace(/&#39;/g, "'");
    after: paste-result`},{id:"com.flyclip.extension.json-formatter",name:"JSON Formatter",category:"text_tools",icon:"{}",description:"Prettify or minify JSON text in place.",descriptionZh:"JSON 格式化美化排版或单行压缩。",hasOptions:!1,type:"js",configYaml:`name: JSON Formatter
...
actions:
  ...
  - title: 压缩 JSON
    ...
    after: paste-result`},{id:"com.flyclip.extension.text-statistics",name:"Text Statistics",category:"text_tools",icon:"123",description:"Count characters, words, lines, and bytes in selected text.",descriptionZh:"实时统计字符数、词数、行数与字节大小并展示于提示栏。",hasOptions:!1,type:"js",configYaml:`name: Text Statistics
...
actions:
  - title: 字数统计
    ...
    after: show-result`},{id:"com.flyclip.extension.sort-lines",name:"Sort Lines",category:"text_tools",icon:"AZ",description:"Sort lines ascending, descending, or remove duplicate lines.",descriptionZh:"多行文本升序、降序排序与行去重。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Sort Lines
...
actions:
  ...
  - title: 行去重 (Unique)
    ...
    after: paste-result`},{id:"com.flyclip.extension.join-lines",name:"Join Lines",category:"text_tools",icon:"->",description:"Join multi-line text into a single line with custom delimiters.",descriptionZh:"多行合并为单行，支持指定逗号、空格、分号等分隔符。",hasOptions:!0,optionsCount:1,type:"js",configYaml:`name: Join Lines
...
actions:
  - title: 合并单行
    ...
    after: paste-result`},{id:"com.flyclip.extension.remove-spaces",name:"Remove Spaces",category:"text_tools",icon:"␣",description:"Collapse duplicate spaces or strip all whitespace characters.",descriptionZh:"消除所有多余空格或压缩连续空白字符。",hasOptions:!1,type:"js",configYaml:`name: Remove Spaces
...
actions:
  ...
  - title: 消除所有空格
    ...
    after: paste-result`},{id:"com.flyclip.extension.full-half-width",name:"全角半角转换",category:"text_tools",icon:"全半",description:"Convert between Full-width and Half-width characters.",descriptionZh:"全角标点字符与半角英文字符双向转换。",hasOptions:!1,type:"js",configYaml:`name: 全角半角转换
...
actions:
  ...
  - title: 半角转全角
    javascript: |
      ...
      return str;
    after: paste-result`},{id:"com.flyclip.extension.timestamp-converter",name:"Timestamp Converter",category:"text_tools",icon:"⏱️",description:"Convert Unix epoch timestamps to local date-time strings.",descriptionZh:"Unix 时间戳转换为本地日期时间，或获取当前秒级时间戳。",hasOptions:!1,type:"js",configYaml:`name: Timestamp Converter
...
actions:
  ...
  - title: 当前时间戳
    ...
    after: paste-result`},{id:"com.flyclip.extension.markdown-tools",name:"Markdown Tools",category:"text_tools",icon:"MD",description:"Wrap text in Markdown bold, inline code, code blocks, or blockquotes.",descriptionZh:"快速为选中文本添加 Markdown 粗体、行内代码、代码块或引用标记。",hasOptions:!1,type:"js",configYaml:`name: Markdown Tools
  ...
  - title: 引用
    javascript: |
      return flyclip.input.text
        ...
        .map(line => \`> \${line}\`)
        .join("\\n");
    after: paste-result`},{id:"com.flyclip.extension.calculate",name:"Calculate",category:"developer",icon:"=?",description:"Evaluate math expressions instantly (e.g. 128*1024, (50+20)/3).",descriptionZh:"即时计算选中的数学表达式并显示结果。",hasOptions:!1,type:"js",configYaml:`name: Calculate
...
actions:
  - title: Amazon
    ...
    spaces as plus: true
    requirements: [text]`}];var o=e.i(62368),l=e.i(56420);let a=(0,l.default)("eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),r=(0,l.default)("settings",[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);var c=e.i(64569),p=e.i(81917);function d({extension:e,onOpenModal:i}){let{lang:s,t:l}=(0,p.useI18n)(),m=n(e.id),u=`https://flyclip-app.github.io/downloads/extensions/${m}.flyclipextz`,x=`flyclip://install-extension?url=${encodeURIComponent(u)}&id=${encodeURIComponent(e.id)}&name=${encodeURIComponent(e.name)}`,f=`/downloads/extensions/${m}.flyclipextz`;return(0,t.jsxs)("div",{className:"bg-[#1c1e27] border border-[#2d3142] hover:border-blue-500/60 rounded-xl p-5 flex flex-col justify-between transition-all hover:-translate-y-1 hover:shadow-xl group",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-start gap-3.5 mb-3",children:[(0,t.jsx)("div",{className:"w-11 h-11 rounded-lg bg-[#14161d] border border-[#2d3142] flex items-center justify-center font-bold text-base text-blue-400 group-hover:border-blue-500/40 transition-colors flex-shrink-0",children:e.icon}),(0,t.jsxs)("div",{className:"min-w-0 flex-1",children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-base leading-snug truncate",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono truncate",children:e.id})]})]}),(0,t.jsx)("p",{className:"text-sm text-slate-400 leading-relaxed mb-4 line-clamp-2",children:"en"===s?e.description||e.descriptionZh:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4 flex-wrap",children:[(0,t.jsx)("span",{className:"text-xs px-2 py-0.5 rounded bg-[#14161d] text-slate-400 border border-[#2d3142]",children:(e=>{if("en"===s)switch(e){case"translation":return"Translation";case"search_ai":return"Search & AI";case"text_tools":return"Productivity";case"developer":return"Developer";case"shopping":return"Utilities";default:return"General"}switch(e){case"translation":return"翻译词典";case"search_ai":return"搜索与AI";case"text_tools":return"文本处理";case"developer":return"开发工具";case"shopping":return"电商媒体";default:return"通用"}})(e.category)}),(0,t.jsx)("span",{className:`text-xs px-2 py-0.5 rounded border font-medium ${"js"===e.type?"bg-emerald-500/10 text-emerald-400 border-emerald-500/20":"url"===e.type?"bg-blue-500/10 text-blue-400 border-blue-500/20":"powershell"===e.type?"bg-amber-500/10 text-amber-400 border-amber-500/20":"bg-[#14161d] text-slate-400 border-[#2d3142]"}`,children:(e=>{if("en"===s)switch(e){case"js":return"JavaScript";case"url":return"URL Action";case"powershell":return"PowerShell";case"keys":return"Key Combo";default:return e.toUpperCase()}switch(e){case"js":return"JavaScript";case"url":return"URL 模板";case"powershell":return"PowerShell";case"keys":return"快捷键";default:return e.toUpperCase()}})(e.type)}),e.hasOptions&&(0,t.jsxs)("span",{className:"text-xs px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-1",children:[(0,t.jsx)(r,{size:11})," ","zh"===s?"选项配置":"Options"]})]}),(0,t.jsxs)("div",{className:"pt-3 border-t border-[#2d3142] flex items-center gap-2",children:[(0,t.jsxs)("button",{onClick:t=>{t.preventDefault();try{window.open(x,"_blank")}catch(e){}i(e,!0)},title:"zh"===s?"一键打开安装引导并唤起客户端":"One-click install into FlyClip",className:"flex-1 py-1.5 px-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center justify-center gap-1.5 transition-all shadow-md shadow-blue-500/20 active:scale-95",children:[(0,t.jsx)(c.Zap,{size:13,className:"text-amber-300"}),(0,t.jsx)("span",{children:l("extensions.installBtn")})]}),(0,t.jsx)("a",{href:f,download:`${m}.flyclipextz`,title:"zh"===s?"下载离线 .flyclipextz 文件":"Download offline .flyclipextz file",className:"p-1.5 rounded-lg bg-[#14161d] border border-[#2d3142] hover:border-slate-400 text-slate-300 hover:text-white transition-colors",children:(0,t.jsx)(o.Download,{size:14})}),(0,t.jsxs)("button",{onClick:()=>i(e,!1),title:"zh"===s?"查看扩展详情与源码":"View details and source",className:"py-1.5 px-2.5 rounded-lg bg-[#14161d] border border-[#2d3142] hover:border-slate-400 text-slate-300 hover:text-white text-xs font-semibold flex items-center justify-center gap-1 transition-colors",children:[(0,t.jsx)(a,{size:13}),(0,t.jsx)("span",{children:"zh"===s?"详情":"Details"})]})]})]})]})}var m=e.i(63676),u=e.i(8734),x=e.i(89664),f=e.i(68877),h=e.i(82022),y=e.i(22016);function g({extension:e,autoTriggerInstall:s,onClose:l}){let[a,r]=(0,i.useState)(!1),[p,d]=(0,i.useState)(!1);if((0,i.useEffect)(()=>{e&&s?d(!0):d(!1)},[e,s]),!e)return null;let b=n(e.id),w=`https://flyclip-app.github.io/downloads/extensions/${b}.flyclipextz`,j=`flyclip://install-extension?url=${encodeURIComponent(w)}&id=${encodeURIComponent(e.id)}&name=${encodeURIComponent(e.name)}`,v=`# flyclip
${e.configYaml}`,S=`flyclip://install-extension?name=${encodeURIComponent(e.name)}&data=${encodeURIComponent(v)}`,C=`/downloads/extensions/${b}.flyclipextz`;return(0,t.jsx)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200",children:(0,t.jsxs)("div",{className:"w-full max-w-2xl bg-[#1c1e27] border border-[#2d3142] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]",children:[(0,t.jsxs)("div",{className:"p-5 border-b border-[#2d3142] flex items-center justify-between bg-[#14161d]",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 rounded-lg bg-[#1c1e27] border border-[#2d3142] flex items-center justify-center font-bold text-blue-400",children:e.icon}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-lg",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono",children:e.id})]})]}),(0,t.jsx)("button",{onClick:l,className:"w-8 h-8 rounded-lg flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-colors",children:(0,t.jsx)(m.X,{size:18})})]}),(0,t.jsxs)("div",{className:"p-6 overflow-y-auto space-y-6 text-sm text-slate-300",children:[p&&(0,t.jsxs)("div",{className:"p-4 rounded-xl bg-blue-500/15 border border-blue-500/30 text-xs sm:text-sm text-blue-200 space-y-2 animate-in fade-in duration-300",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 font-bold text-white",children:[(0,t.jsx)(c.Zap,{size:16,className:"text-amber-400 animate-pulse"}),(0,t.jsx)("span",{children:"正在尝试呼起 FlyClip 客户端安装..."})]}),(0,t.jsxs)("button",{onClick:()=>{d(!0);try{window.open(j,"_blank")}catch(e){}},className:"px-2.5 py-1 rounded bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors flex items-center gap-1",children:[(0,t.jsx)(h.ExternalLink,{size:12}),(0,t.jsx)("span",{children:"重新呼起"})]})]}),(0,t.jsxs)("p",{className:"text-xs text-slate-400 leading-relaxed",children:["若您的浏览器弹出授权提示，请点击「打开 FlyClip」。若您的电脑尚未安装 FlyClip，可"," ",(0,t.jsx)(y.default,{href:"/download",className:"text-blue-400 underline hover:text-blue-300",children:"下载客户端"})," ","或直接选择下方【方式二：下载离线扩展包】。"]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider block mb-1",children:"功能描述"}),(0,t.jsx)("p",{className:"text-slate-300",children:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{className:"space-y-3",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider block",children:"安装与更新方式"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:[(0,t.jsxs)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-blue-500/40 space-y-2 flex flex-col justify-between",children:[(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 font-bold text-white text-xs",children:[(0,t.jsx)(c.Zap,{size:14,className:"text-amber-400"}),(0,t.jsx)("span",{children:"方式一：一键唤起安装 (绑定更新源)"})]}),(0,t.jsxs)("p",{className:"text-[11px] text-slate-400 leading-relaxed",children:["在新窗口呼出 ",(0,t.jsx)("code",{children:"flyclip://"})," 协议，自动绑定官方更新源，支持后续无感自动更新。"]})]}),(0,t.jsxs)("a",{href:j,target:"_blank",rel:"noopener noreferrer",onClick:()=>d(!0),className:"w-full py-2 px-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs flex items-center justify-center gap-1.5 transition-colors shadow-md shadow-blue-500/20",children:[(0,t.jsx)(c.Zap,{size:13,className:"text-amber-300"}),(0,t.jsx)("span",{children:"一键安装到 FlyClip"}),(0,t.jsx)(h.ExternalLink,{size:12})]})]}),(0,t.jsxs)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-[#2d3142] space-y-2 flex flex-col justify-between",children:[(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 font-bold text-white text-xs",children:[(0,t.jsx)(o.Download,{size:14,className:"text-blue-400"}),(0,t.jsx)("span",{children:"方式二：下载离线包 (.flyclipextz)"})]}),(0,t.jsxs)("p",{className:"text-[11px] text-slate-400 leading-relaxed",children:["下载 ",(0,t.jsxs)("code",{children:[b,".flyclipextz"]})," 文件，双击或拖入 FlyClip 窗口即可完成安装。"]})]}),(0,t.jsxs)("a",{href:C,download:`${b}.flyclipextz`,className:"w-full py-2 px-3 rounded-lg bg-[#1c1e27] border border-[#2d3142] hover:border-slate-400 text-slate-200 font-semibold text-xs flex items-center justify-center gap-1.5 transition-colors",children:[(0,t.jsx)(o.Download,{size:13}),(0,t.jsx)("span",{children:"下载离线文件"})]})]})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider",children:"方式三：划选即装 Snippet (直接用鼠标划选下方文本即可)"}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsxs)("a",{href:S,target:"_blank",rel:"noopener noreferrer",className:"text-xs text-amber-400 hover:text-amber-300 flex items-center gap-1 font-medium",children:[(0,t.jsx)(c.Zap,{size:12}),(0,t.jsx)("span",{children:"载入 Snippet"}),(0,t.jsx)(h.ExternalLink,{size:11})]}),(0,t.jsxs)("button",{onClick:()=>{navigator.clipboard.writeText(v),r(!0),setTimeout(()=>r(!1),2e3)},className:"text-xs text-blue-400 hover:text-blue-300 flex items-center gap-1 font-medium",children:[a?(0,t.jsx)(x.Check,{size:12,className:"text-green-400"}):(0,t.jsx)(u.Copy,{size:12}),(0,t.jsx)("span",{children:a?"已复制":"复制代码"})]})]})]}),(0,t.jsx)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-[#2d3142] overflow-x-auto font-mono text-xs text-slate-200 leading-relaxed select-all",children:(0,t.jsx)("pre",{children:v})})]})]}),(0,t.jsxs)("div",{className:"p-4 border-t border-[#2d3142] bg-[#14161d] flex items-center justify-between gap-3",children:[(0,t.jsxs)(y.default,{href:"/download",className:"text-xs text-blue-400 hover:text-blue-300 flex items-center gap-1 font-medium",children:[(0,t.jsx)("span",{children:"还没有 FlyClip 客户端？立即下载"}),(0,t.jsx)(f.ArrowRight,{size:13})]}),(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsxs)("a",{href:j,target:"_blank",rel:"noopener noreferrer",className:"px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs sm:text-sm transition-colors flex items-center gap-1.5 shadow-md shadow-blue-500/20",children:[(0,t.jsx)(c.Zap,{size:14,className:"text-amber-300"}),(0,t.jsx)("span",{children:"一键安装"}),(0,t.jsx)(h.ExternalLink,{size:12})]}),(0,t.jsx)("button",{onClick:l,className:"px-4 py-2 rounded-lg bg-[#1c1e27] border border-[#2d3142] hover:bg-[#242733] text-slate-300 font-medium text-xs sm:text-sm transition-colors",children:"关闭"})]})]})]})})}var b=e.i(66595),w=e.i(28623);e.s(["default",0,function(){let[e,n]=(0,i.useState)(""),[o,l]=(0,i.useState)("all"),[a,r]=(0,i.useState)(null),[c,m]=(0,i.useState)(!1),{t:u,lang:x}=(0,p.useI18n)(),f=(e,t=!1)=>{r(e),m(t)},h=[{id:"all",label:u("extensions.all")},{id:"translation",label:u("extensions.trans")},{id:"search_ai",label:u("extensions.search")},{id:"text_tools",label:u("extensions.prod")},{id:"developer",label:u("extensions.dev")},{id:"shopping",label:u("extensions.util")}],y=s.filter(t=>{let i="all"===o||t.category===o,n=e.toLowerCase().trim(),s=!n||t.name.toLowerCase().includes(n)||t.id.toLowerCase().includes(n)||t.description&&t.description.toLowerCase().includes(n)||t.descriptionZh&&t.descriptionZh.toLowerCase().includes(n);return i&&s});return(0,t.jsxs)("div",{className:"py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto",children:[(0,t.jsxs)("div",{className:"text-center max-w-2xl mx-auto mb-10 space-y-2",children:[(0,t.jsx)("span",{className:"text-xs font-bold text-blue-400 uppercase tracking-wider",children:"Extension Marketplace"}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-extrabold text-white",children:u("extensions.title")}),(0,t.jsx)("p",{className:"text-slate-400 text-sm sm:text-base",children:u("extensions.subtitle")})]}),(0,t.jsxs)("div",{className:"space-y-4 mb-10",children:[(0,t.jsxs)("div",{className:"relative w-full max-w-2xl mx-auto",children:[(0,t.jsx)(b.Search,{className:"absolute left-4 top-1/2 -translate-y-1/2 text-slate-500",size:18}),(0,t.jsx)("input",{type:"text",placeholder:u("extensions.searchPlaceholder"),value:e,onChange:e=>n(e.target.value),className:"w-full pl-11 pr-4 py-3 rounded-xl bg-[#1c1e27] border border-[#2d3142] text-sm text-slate-100 focus:outline-none focus:border-blue-500 transition-colors placeholder:text-slate-500 shadow-lg"})]}),(0,t.jsxs)("div",{className:"flex items-center justify-between flex-wrap gap-3 pt-2",children:[(0,t.jsx)("div",{className:"flex items-center gap-2 flex-wrap",children:h.map(e=>(0,t.jsx)("button",{onClick:()=>l(e.id),className:`px-3.5 py-1.5 rounded-full text-xs font-medium transition-colors ${o===e.id?"bg-blue-600 text-white font-semibold shadow-md shadow-blue-500/20":"bg-[#1c1e27] border border-[#2d3142] text-slate-400 hover:text-white hover:border-slate-400"}`,children:e.label},e.id))}),(0,t.jsx)("span",{className:"text-xs text-slate-500 font-medium",children:"zh"===x?`找到 ${y.length} 个扩展`:`Found ${y.length} extensions`})]})]}),y.length>0?(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:y.map(e=>(0,t.jsx)(d,{extension:e,onOpenModal:f},e.id))}):(0,t.jsxs)("div",{className:"text-center py-20 bg-[#14161d] border border-[#2d3142] rounded-2xl p-8",children:[(0,t.jsx)(w.Sparkles,{className:"w-10 h-10 text-slate-500 mx-auto mb-3"}),(0,t.jsx)("h3",{className:"text-lg font-bold text-white mb-1",children:"zh"===x?"没有找到匹配的扩展":"No matching extensions"}),(0,t.jsx)("p",{className:"text-sm text-slate-400",children:"zh"===x?"尝试更换搜索词或选择其他分类":"Try searching another term or choosing another category"})]}),a&&(0,t.jsx)(g,{extension:a,onClose:()=>r(null),autoTriggerInstall:c})]})}],93063)}]);
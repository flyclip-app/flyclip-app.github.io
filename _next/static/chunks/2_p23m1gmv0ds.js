...
actions:
  - title: Amazon
    ...
    spaces as plus: true
    requirements: [text]`}];var n=e.i(8734),s=e.i(56420);let l=(0,s.default)("eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),a=(0,s.default)("settings",[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);var r=e.i(89664);function c({extension:e,onOpenModal:o}){let[s,p]=(0,i.useState)(!1);return(0,t.jsxs)("div",{className:"bg-[#1c1e27] border border-[#2d3142] hover:border-blue-500/60 rounded-xl p-5 flex flex-col justify-between transition-all hover:-translate-y-1 hover:shadow-xl group",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-start gap-3.5 mb-3",children:[(0,t.jsx)("div",{className:"w-11 h-11 rounded-lg bg-[#14161d] border border-[#2d3142] flex items-center justify-center font-bold text-base text-blue-400 group-hover:border-blue-500/40 transition-colors flex-shrink-0",children:e.icon}),(0,t.jsxs)("div",{className:"min-w-0 flex-1",children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-base leading-snug truncate",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono truncate",children:e.id})]})]}),(0,t.jsx)("p",{className:"text-sm text-slate-400 leading-relaxed mb-4 line-clamp-2",children:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4 flex-wrap",children:[(0,t.jsx)("span",{className:"text-xs px-2 py-0.5 rounded bg-[#14161d] text-slate-400 border border-[#2d3142]",children:(e=>{switch(e){case"translation":return"翻译词典";case"search_ai":return"搜索与AI";case"text_tools":return"文本处理";case"developer":return"开发工具";case"shopping":return"电商媒体";default:return"通用"}})(e.category)}),(0,t.jsx)("span",{className:"text-xs px-2 py-0.5 rounded bg-[#14161d] text-slate-400 border border-[#2d3142]",children:e.type.toUpperCase()}),e.hasOptions&&(0,t.jsxs)("span",{className:"text-xs px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-1",children:[(0,t.jsx)(a,{size:11})," 选项配置"]})]}),(0,t.jsxs)("div",{className:"pt-3 border-t border-[#2d3142] flex items-center gap-2",children:[(0,t.jsxs)("button",{onClick:()=>{navigator.clipboard.writeText(e.configYaml),p(!0),setTimeout(()=>p(!1),2e3)},className:"flex-1 py-1.5 px-3 rounded-lg bg-blue-600/10 hover:bg-blue-600 text-blue-400 hover:text-white text-xs font-semibold flex items-center justify-center gap-1.5 transition-all",children:[s?(0,t.jsx)(r.Check,{size:13,className:"text-green-400"}):(0,t.jsx)(n.Copy,{size:13}),(0,t.jsx)("span",{children:s?"已复制 Snippet":"复制 Snippet"})]}),(0,t.jsxs)("button",{onClick:()=>o(e),className:"py-1.5 px-3 rounded-lg bg-[#14161d] border border-[#2d3142] hover:border-slate-400 text-slate-300 hover:text-white text-xs font-semibold flex items-center justify-center gap-1 transition-colors",children:[(0,t.jsx)(l,{size:13}),(0,t.jsx)("span",{children:"详情"})]})]})]})]})}var p=e.i(63676);let d=(0,s.default)("info",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]]);function m({extension:e,onClose:o}){let[s,l]=(0,i.useState)(!1);if(!e)return null;let a=()=>{navigator.clipboard.writeText(e.configYaml),l(!0),setTimeout(()=>l(!1),2e3)};return(0,t.jsx)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200",children:(0,t.jsxs)("div",{className:"w-full max-w-xl bg-[#1c1e27] border border-[#2d3142] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]",children:[(0,t.jsxs)("div",{className:"p-5 border-b border-[#2d3142] flex items-center justify-between bg-[#14161d]",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 rounded-lg bg-[#1c1e27] border border-[#2d3142] flex items-center justify-center font-bold text-blue-400",children:e.icon}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"font-bold text-slate-100 text-lg",children:e.name}),(0,t.jsx)("p",{className:"text-xs text-slate-500 font-mono",children:e.id})]})]}),(0,t.jsx)("button",{onClick:o,className:"w-8 h-8 rounded-lg flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-colors",children:(0,t.jsx)(p.X,{size:18})})]}),(0,t.jsxs)("div",{className:"p-6 overflow-y-auto space-y-4 text-sm text-slate-300",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider block mb-1",children:"功能描述"}),(0,t.jsx)("p",{className:"text-slate-300",children:e.descriptionZh||e.description})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-400 uppercase tracking-wider",children:"Config.yaml 扩展配置"}),(0,t.jsxs)("button",{onClick:a,className:"text-xs text-blue-400 hover:text-blue-300 flex items-center gap-1 font-medium",children:[s?(0,t.jsx)(r.Check,{size:12,className:"text-green-400"}):(0,t.jsx)(n.Copy,{size:12}),(0,t.jsx)("span",{children:s?"已复制":"复制全部"})]})]}),(0,t.jsx)("div",{className:"p-4 rounded-xl bg-[#14161d] border border-[#2d3142] overflow-x-auto font-mono text-xs text-slate-200 leading-relaxed",children:(0,t.jsx)("pre",{children:e.configYaml})})]}),(0,t.jsxs)("div",{className:"p-3.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-xs text-blue-200 flex items-start gap-2.5",children:[(0,t.jsx)(d,{size:16,className:"text-blue-400 flex-shrink-0 mt-0.5"}),(0,t.jsxs)("div",{className:"leading-relaxed",children:[(0,t.jsx)("strong",{children:"安装方式："})," 将此配置保存为 ",(0,t.jsx)("code",{children:"Config.yaml"})," 并放入 ",(0,t.jsxs)("code",{children:["%APPDATA%\\flyclip\\extensions\\",e.name,".flyclipext"]})," 文件夹内，重启或刷新 FlyClip 即可生效。"]})]})]}),(0,t.jsxs)("div",{className:"p-4 border-t border-[#2d3142] bg-[#14161d] flex items-center justify-end gap-3",children:[(0,t.jsxs)("button",{onClick:a,className:"px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm transition-colors flex items-center gap-1.5 shadow-md shadow-blue-500/20",children:[s?(0,t.jsx)(r.Check,{size:15}):(0,t.jsx)(n.Copy,{size:15}),(0,t.jsx)("span",{children:"复制配置代码"})]}),(0,t.jsx)("button",{onClick:o,className:"px-4 py-2 rounded-lg bg-[#1c1e27] border border-[#2d3142] hover:bg-[#242733] text-slate-300 font-medium text-sm transition-colors",children:"关闭"})]})]})})}var h=e.i(66595),u=e.i(28623);e.s(["default",0,function(){let[e,n]=(0,i.useState)(""),[s,l]=(0,i.useState)("all"),[a,r]=(0,i.useState)(null),p=o.filter(t=>{let i="all"===s||t.category===s,o=e.toLowerCase().trim(),n=!o||t.name.toLowerCase().includes(o)||t.id.toLowerCase().includes(o)||t.description&&t.description.toLowerCase().includes(o)||t.descriptionZh&&t.descriptionZh.toLowerCase().includes(o);return i&&n});return(0,t.jsxs)("div",{className:"py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto",children:[(0,t.jsxs)("div",{className:"text-center max-w-2xl mx-auto mb-10 space-y-2",children:[(0,t.jsx)("span",{className:"text-xs font-bold text-blue-400 uppercase tracking-wider",children:"Extension Marketplace"}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-extrabold text-white",children:"官方与社区扩展中心"}),(0,t.jsx)("p",{className:"text-slate-400 text-sm sm:text-base",children:"已为 Windows 深度优化 40+ 个原生扩展，点击「复制 Snippet」或查看配置即可秒级使用。"})]}),(0,t.jsxs)("div",{className:"space-y-4 mb-10",children:[(0,t.jsxs)("div",{className:"relative w-full max-w-2xl mx-auto",children:[(0,t.jsx)(h.Search,{className:"absolute left-4 top-1/2 -translate-y-1/2 text-slate-500",size:18}),(0,t.jsx)("input",{type:"text",placeholder:"搜索扩展名称、标识符、功能描述或关键词...",value:e,onChange:e=>n(e.target.value),className:"w-full pl-11 pr-4 py-3 rounded-xl bg-[#1c1e27] border border-[#2d3142] text-sm text-slate-100 focus:outline-none focus:border-blue-500 transition-colors placeholder:text-slate-500 shadow-lg"})]}),(0,t.jsxs)("div",{className:"flex items-center justify-between flex-wrap gap-3 pt-2",children:[(0,t.jsx)("div",{className:"flex items-center gap-2 flex-wrap",children:[{id:"all",label:"全部"},{id:"translation",label:"翻译词典"},{id:"search_ai",label:"搜索与 AI"},{id:"text_tools",label:"文本处理"},{id:"developer",label:"开发工具"},{id:"shopping",label:"电商媒体"}].map(e=>(0,t.jsx)("button",{onClick:()=>l(e.id),className:`px-3.5 py-1.5 rounded-full text-xs font-medium transition-colors ${s===e.id?"bg-blue-600 text-white font-semibold shadow-md shadow-blue-500/20":"bg-[#1c1e27] border border-[#2d3142] text-slate-400 hover:text-white hover:border-slate-400"}`,children:e.label},e.id))}),(0,t.jsxs)("span",{className:"text-xs text-slate-500 font-medium",children:["找到 ",p.length," 个扩展"]})]})]}),p.length>0?(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:p.map(e=>(0,t.jsx)(c,{extension:e,onOpenModal:r},e.id))}):(0,t.jsxs)("div",{className:"text-center py-20 bg-[#14161d] border border-[#2d3142] rounded-2xl p-8",children:[(0,t.jsx)(u.Sparkles,{className:"w-10 h-10 text-slate-500 mx-auto mb-3"}),(0,t.jsx)("h3",{className:"text-lg font-bold text-white mb-1",children:"没有找到匹配的扩展"}),(0,t.jsx)("p",{className:"text-sm text-slate-400",children:"尝试更换搜索词或选择其他分类"})]}),(0,t.jsx)(m,{extension:a,onClose:()=>r(null)})]})}],93063)}]);